    ...
    <div>
      ...
      <div className='grid'>
        ...
        <div>
          ...
          <AiFillInstagram className='bg-white p-1 h-[35px] w-[35px] rounded-full icon text-blueColor'/>
          <BsFacebook className='bg-white p-1 h-[35px] w-[35px] rounded-full icon text-blueColor'/>
          <AiOutlineTwitter className='bg-white p-[1] h-[35px] w-[35px] rounded-full icon text-blueColor'/>
